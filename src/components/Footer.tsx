...
const footerLinks = [
  ...
  { name: "Payment Plan", href: "#payment" },
  { name: "Floor Plan", href: "#floor" },
  { name: "Master Plan", href: "#master" },
  { name: "FAQs", href: "#faqs" },
];
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              An unparalleled 81 million square feet development by EMAAR Properties. 
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 text-gray-300">
                ...
                <span>Dubailand, E611 Emirates Road, Dubai, UAE</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <span>info@heightscountryclub.ae</span>
              </div>
            </div>

            <div className="mt-8">
              <h4 className="font-semibold mb-3">Nearby Destinations</h4>
