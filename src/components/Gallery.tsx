...
const galleryImages = [
  {
    id: 1,
    src: "/height-gallery-picture/1.png",
    alt: "The Heights Country Club Dubai - Aerial View",
    category: "Community",
  },
  {
    id: 3,
    src: "/height-gallery-picture/3.png",
    alt: "Elegant Interior Design",
    category: "Villas",
  },
  {
    id: 4,
    src: "/height-gallery-picture/4.png",
    alt: "Modern Townhouse",
    category: "Townhouses",
  },
  {
    id: 5,
    src: "/height-gallery-picture/5.png",
    alt: "Community Amenities",
    category: "Amenities",
  },
  {
    id: 6,
    src: "/height-gallery-picture/6.png",
    alt: "Spacious Living Area",
    category: "Villas",
  },
  {
    id: 7,
    src: "/height-gallery-picture/7.png",
    alt: "Premium Finishing",
    category: "Townhouses",
  },
  {
    id: 8,
    src: "/height-gallery-picture/8.png",
    alt: "Lush Green Landscapes",
    category: "Community",
  },
  {
    id: 9,
    src: "/height-gallery-picture/9.png",
    alt: "Wellness Center",
    category: "Amenities",
  },
  {
    id: 10,
    src: "/height-gallery-picture/10.png",
    alt: "3 Bedroom Villa",
    category: "Villas",
  },
  {
    id: 11,
    src: "/height-gallery-picture/11.png",
    alt: "4 Bedroom Villa",
    category: "Villas",
  },
  {
    id: 12,
    src: "/height-gallery-picture/12.png",
    alt: "5 Bedroom Villa",
    category: "Villas",
  },
  {
  ...
  return (
    <section id="gallery" className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="items-center text-start lg:text-center mb-12">
