    ...
    <section id="amenities" className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="lg:text-center mb-16" data-aos="fade-up">
          <div className="inline-flex items-start lg:items-center gap-2 bg-[#1F2937]/10 text-[#1F2937] px-4 py-2 rounded-full text-sm mb-4 font-medium">
        ...
        <div className="relative rounded-3xl overflow-hidden" data-aos="fade-up" data-aos-delay="400">
          ...
          <div className="relative p-8 md:p-12 items-center text-start lg:items-center lg:text-center">
